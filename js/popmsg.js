var popmsg =function () {
   ...
   var init= function () {
         this.position_value="top-center";//top-center:上中,top-left:上左,top-right:上右,center-center:中中,center-left:中左,center-right:中右,bottom-center:下中,bottom-left:下左,bottom-right:下右
         this.type_value="com-msg";//com-msg:普通消息,info-msg:信息消息,success-msg:成功消息,warning-msg:警告消息,error-msg:错误消息
         this.time_value=3000;
         this.mask_value=false;
         this.msg_value="提示信息";
         this.size_value="m";//m:medium,s:small,l:large
         return this;
    }
    //设置位置
    var pos=function(val) {
        val=val||"top-center";
        this.position_value = val;
        return this;
    }
